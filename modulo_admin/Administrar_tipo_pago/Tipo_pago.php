...
<body class="body">
    ...
    <div class="my-container">
        ...
        <form action="Guardar_Tipo_Pago.php" method="POST" id="form">

            <!-- titulo -->
            <p class="Titulo">Registrar tipo de pago</p>

            <!-- fila contenedor de campos -->
            <div class="row justify-content-md-center">
                <!-- primer fila -->
                <div class="col-md-6 col-sm-3 columna">
                    <input type="text" name="TipoPago" placeholder="Ingrese el tipo de pago" onkeypress="return soloLetras(event)">Tipo de pago
                </div>
            </div>
                ...
                <table id="tabla" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <!-- Filas para mostrar -->
                                    ...
                                    $db = new Database();
                                    $consulta = $db->connect()->prepare('SELECT * FROM t_tipo_pago');
                                    $consulta->execute();
                                    while($row=$consulta->fetch()){
                                        ?>
                                        <!-- Imprime la informacion obtenida en la tabla -->
                                        <tr>
                                            <td><?php echo $row['IDTipoPago']?></td>
                                            <td><?php echo $row['TipoPago']?></td>

                                            <td><a class="btn btn-primary " href="Modificar_Tipo_Pago.php?IDTipoPago=<?php echo $row['IDTipoPago'];?>">Modificar</a></td>
                                        </tr>
