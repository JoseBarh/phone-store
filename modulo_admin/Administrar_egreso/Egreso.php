...
<body class="body">
    ...
    <div class="my-container">
        ...
        <form action="Guardar_egreso.php" method="POST" id="form">

            <!-- titulo -->
            <p class="Titulo">Registrar egreso</p>
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-4 col-sm-3 columna">
                    <div class="Descripcion">
                        <input type="text" name="Descripcion" placeholder="Descripción  de gasto">Descripción
                    </div>
                </div>

                <div class="col-md-4 col-sm-3 columna">
                    <div class="Egreso">
                        <input type="textarea " name="Egreso" placeholder="Gasto de empresa" onkeypress="return soloNumeros(event)">Gasto
                    </div>
                </div>
                ...
                <table id="tabla" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <!-- Filas para mostrar -->
                                    ...
                                    $db = new Database();
                                    $consulta = $db->connect()->prepare('SELECT * FROM t_egreso');
                                    $consulta->execute();
                                    while($row=$consulta->fetch()){
                                        ?>
                                        <!-- Imprime la informacion obtenida en la tabla -->
                                        <tr>
                                            <td><?php echo $row['IDEgreso']?></td>
                                            <td><?php echo $row['Descripcion']?></td>
                                            <td><?php echo $row['Egreso']?></td>
                                            <td><?php echo $row['Fecha']?></td>

                                            <td><a class="btn btn-primary " href="Modificar_egreso.php?IDEgreso=<?php echo $row['IDEgreso'];?>">Modificar</a></td>
                                        </tr>
