...
<body class="body">
    ...
    <div class="my-container">
        ...
        <form action="Guardar_Tipo_Producto.php" method="POST" id="form">

            <!-- titulo -->
            <p class="Titulo">Registrar tipo de producto</p>

            <!-- fila contenedor de campos -->
            <div class="row justify-content-md-center">
                <!-- primer fila -->
                <div class="col-md-6 col-sm-3 columna">
                    <input type="text" name="TipoProducto" placeholder="Ingrese el tipo de producto" onkeypress="return soloLetras(event)">Nombre del tipo de producto
                </div>
            </div>
                ...
                <table id="tabla" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        <!-- Filas para mostrar -->
                                    ...
                                    $db = new Database();
                                    $consulta = $db->connect()->prepare('SELECT * FROM t_tipo_producto');
                                    $consulta->execute();
                                    while($row=$consulta->fetch()){
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary " href="Modificar_Tipo_Producto.php?IDTipoProducto=<?php echo $row['IDTipoProducto'];?>">Modificar</a></td>
                                        </tr>
