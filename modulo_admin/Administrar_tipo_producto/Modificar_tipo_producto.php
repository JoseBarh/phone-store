<?php
    ...
    $db = new Database();
    $consulta = $db->connect()->prepare("SELECT * FROM t_tipo_producto WHERE IDTipoProducto='$IDTipoProducto'");
    $consulta->execute();
    $row=$consulta->fetch();
...
<body class="body">
    ...
    <div class="my-container">
        <form action="Actualizar_tipo_producto.php?IDTipoProducto=<?php echo $row['IDTipoProducto'];?>" method="POST" id="form">
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-6 col-sm-3 columna">
                    <input type="text" name="TipoProducto" placeholder="Ingrese nombre del tipo de producto" value="<?php echo $row['TipoProducto'];?>" onkeypress="return soloLetras(event)">Nombre del tipo de producto
                </div>
            </div>
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-6 col-sm-3 columna">
                    <a style="cursor: pointer;" class="btn_registrar" href="Tipo_Producto.php">Cancelar</a>
                </div>
            </div>
